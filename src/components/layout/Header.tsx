    ...
    >
      ...
      <div className='layout flex h-14 items-center justify-between px-2'>
        ...
        <div className='flex items-center justify-between '>
          ...
          >
            {open ? (
              <IoClose className='inline-block h-6 w-6 stroke-current dark:text-slate-400' />
            ) : (
              <HiOutlineMenu className='inline-block h-6 w-6 stroke-current checked:hidden dark:text-slate-400' />
            )}
          </button>
        </div>
      </div>
