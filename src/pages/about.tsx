    ...
    <Layout>
      ...
      <main>
        <section className='dark:bg-dark'>
          <div
            className='layout relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50
            py-8 lg:py-12 '
          >
              ...
              <div className='relative w-full bg-white px-6 py-12 shadow-xl shadow-slate-700/10 ring-1 ring-gray-900/5 md:mx-auto md:max-w-3xl lg:max-w-4xl lg:pt-16 lg:pb-28'>
                ...
                <div className='prose prose-slate mx-auto mt-8 lg:prose-lg'>
                  ...
                  <p>
                    ...
                    don&apos;t want to have to remove annoying margins every
                    time you use a <code>p</code> element in a piece of your
                    dashboard UI. And I doubt you really want your blog posts to
                    use the user-agent styles either — you want them to look{' '}
                  ...
                  <pre>
                    <code className='language-html'>
                      ...
                      earning such an iconic status in our culture that kids
                  ...
                  <p>
                    ...
                    I&apos;ve written to dogfood the plugin itself. It includes
                    every sensible typographic element I could think of, like{' '}
                  ...
                  <ol>
                    ...
                    <li>
                      ...
                      three items looks more realistic than a list with two
                      items.
                    </li>
                  </ol>
                  ...
                  <p>
                    So that&apos;s a header for you — with any luck if
                    we&apos;ve done our job correctly that will look pretty
                    reasonable.
                  </p>
                  <p>
                  ...
                  <blockquote>
                    <p>
                      ...
                      stuff to look like trash. Make it good then it won&apos;t
                      be bad.
                    </p>
                  </blockquote>
                  <p>
                  ...
                  <p>
                    ...
                    space, like I already mentioned above. Now let&apos;s see
                  ...
                  <ul>
                    <li>
                      ...
                      <p>
                        ...
                        could make a strong argument that you just
                    ...
                    <li>
                      ...
                      <p>
                        ...
                        had one item, and we really want this to look realistic.
                        That&apos;s why I&apos;ve added this second list item so
                        I actually have something to look at when writing the
                        styles.
                      </p>
                    </li>
                    <li>
                      ...
                      <p>
                        ...
                        two items but three is definitely not worse, and since I
                  ...
                  <p>
                    ...
                    they want to style their code blocks but it wouldn&apos;t
                    hurt to make them look <em>okay</em> out of the box, even
                  ...
                  <p>
                    ...
                    like Medium don&apos;t even let you do it, but I guess since
                    some of you goofballs are going to do it we have to carry
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          ...
                          something but you are just creating a gross shape on
                  ...
                  <p>
                    ...
                    decently sized block of text. I can&apos;t explain why I
                    want things to end that way but I have to assume it&apos;s
                    because I think things will look weird or unbalanced if
